...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PhD Book Assistant" },
      {
        name: "description",
        content:
          "Grounded question answering on 'How to write a PhD in Biological Sciences' with citations to the source text.",
      },
      { property: "og:title", content: "PhD Book Assistant" },
      {
